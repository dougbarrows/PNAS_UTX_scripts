...
counts <- readRDS("../../hg19/normalizedCounts_revisedPatientNames_TCGAbiolinks.RData")
...
patient_list_path <- "../../hg19/UTX_MLL3_MLL4_PIK3CA_FGFR3.alterations_across_samples.tsv"
...
writeLines("session_info.txt", text = capture.output(sessionInfo()))
```
